...
public class Timer {
	...
	public void initializeClock() {
		timer = new Timeline(new KeyFrame(Duration.millis(10), (actionEvent) -> {
			...
			if (milliLitres < 10) {
				...
				simController.milliLitresLabel.setText(getMilliLitresText0());
				if (milliLitres == 0) {
					litres++;
					milliLitres++;
				...
				simController.milliLitresLabel.setText(getMilliLitresText());
				if (milliLitres == 0) {
					litres++;
					milliLitres++;
				} else if (milliLitres < 99) {
			...
			simController.litresLabel.setText(getLitresText());
			...
			simController.priceCompLabel.setText(String.valueOf(getPriceCompRound()) + " €");
	...
	public void resetTimer(ActionEvent actionEvent) {	
		...
		simController.litresLabel.setText("0");
		simController.milliLitresLabel.setText("00");
		simController.priceCompLabel.setText("0.00 €");
	}
}
