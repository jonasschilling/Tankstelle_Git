...
//		SalesModel model = SalesModel.getInstance();
...
//		simModel.setSuperPrice(1.234f);
		model.getTank("Diesel").setPricePerLitre(5.678f);
		...
		superCapLabel.setText(String.valueOf(model.getTank("Super").getAbsFuelLevel() + "/" + model.getTank("Super").getCapacity()) + " L");
		dieselCapLabel.setText(String.valueOf(model.getTank("Diesel").getAbsFuelLevel() + "/" + model.getTank("Diesel").getCapacity()) + " L");
		
		superBar.setProgress((double)(model.getTank("Super").getAbsFuelLevel() / model.getTank("Super").getCapacity()));
		dieselBar.setProgress((double)(model.getTank("Diesel").getAbsFuelLevel() / model.getTank("Diesel").getCapacity()));
...
//		simModel.setSuperPrice(Float.parseFloat(text))
	...
	public void refreshProgress() {
		superBar.setProgress((double) model.getTank("Super").getAbsFuelLevel() / model.getTank("Super").getCapacity());
		dieselBar.setProgress((double) (model.getTank("Diesel").getAbsFuelLevel() / model.getTank("Super").getCapacity()));
	}
