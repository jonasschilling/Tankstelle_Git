...
public class SalesModel {
	...
	Product jupiter = new Product(358, "Jupiter Schokoriegel", "St�ck", 150, 150, 0.19f);
...
//	Shoppingcart shoppingCart = new Shoppingcart();
    ...
    private static String path = "src/javafx/resources/Preise/";
                ...
                static Product jupiter = new Product(358, "Jupiter Schokoriegel", "St�ck", 150, 150, 0.19f);
                static Product bull = new Product(992, "Sitting Bull", "Dose", 50, 50, 0.29f);
                static Product pizza = new Product(101, "TK-Pizza Deluxe", "St�ck", 20, 20, 0.89f);
...
//            }
                ...
                public static void writeStock() {
                               ...
                               try {
                                               fw = new FileWriter(file);
                                               bw = new BufferedWriter(fw);
                                               bw.write("Nummer;Name;Lagereinheit;Menge;MaxMenge");
                                               bw.newLine();
